...
[![Build Status](https://travis-ci.org/trekhleb/learn-python.svg?branch=master)](https://github.com/Chameera-de)

> This is a collection of Python scripts that are split by [topics](#table-of-contents) and contain 
code examples with explanations, different use cases and links to further readings.

_Read this in_ [_Sinhaleese_](README.pt-BR.md).
...
You may support this project via ❤️️ [GitHub](https://github.com/Chameera-de)
